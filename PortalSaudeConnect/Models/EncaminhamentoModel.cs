...
//        [ForeignKey("ClinicaOrigemId")]
//        public ClinicaModel? ClinicaOrigem { get; set; }

//        [Display(Name = "Clínica Sisac Brasil")]
//        public int ClinicaOrigemId { get; set; }

//        [Required(ErrorMessage = "A clínica de destino é obrigatória.")]
//        [Display(Name = "Clínica Parceira")]
...
//    }
//}
// Em PortalSaudeConnect.Models/EncaminhamentoModel.cs
...
namespace PortalSaudeConnect.Models
{
    public class EncaminhamentoModel
    {
        ...
        // <<<<<<<<<< PROPRIEDADES JÁ EXISTENTES, APENAS CONFIRMANDO >>>>>>>>>>
        [Required(ErrorMessage = "A clínica de origem é obrigatória.")]
        public int ClinicaOrigemId { get; set; }

        [ForeignKey("ClinicaOrigemId")]
        public ClinicaModel? ClinicaOrigem { get; set; } // Propriedade de navegação para a Clínica de Origem

        [Required(ErrorMessage = "A clínica de destino é obrigatória.")]
        public int ClinicaDestinoId { get; set; }

        [ForeignKey("ClinicaDestinoId")]
        public ClinicaModel? ClinicaDestino { get; set; } // Propriedade de navegação para a Clínica de Destino
        // <<<<<<<<<< FIM DA CONFIRMAÇÃO >>>>>>>>>>
        ...
        [DataType(DataType.MultilineText)]
        [StringLength(500, ErrorMessage = "As observações internas não podem exceder 500 caracteres.")]
        public string? ObservacoesDaSolicitacao { get; set; }

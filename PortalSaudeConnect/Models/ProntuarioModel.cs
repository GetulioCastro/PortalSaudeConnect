...
namespace PortalSaudeConnect.Models
{
    public class ProntuarioModel
    {
        ...
        [Required(ErrorMessage = "O ID do paciente é obrigatório para o prontuário.")]
        public int PacienteId { get; set; }

        [ForeignKey("PacienteId")]
        public PacienteModel? Paciente { get; set; }

        [Required(ErrorMessage = "A clínica do prontuário é obrigatória.")]
        ...
        [DataType(DataType.MultilineText)]
        [StringLength(2000, ErrorMessage = "O histórico clínico resumido não pode exceder 2000 caracteres.")]
        [Display(Name = "Histórico Clínico Resumido")]

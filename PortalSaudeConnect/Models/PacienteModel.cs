...
namespace PortalSaudeConnect.Models
{
    public class PacienteModel
    {
        ...
        [StringLength(10)]
        public string Sexo { get; set; } // Ex: "M", "F", "Outro"
        ...
        // Adicione outras informações do paciente conforme necessário (endereço, etc.)

        // Propriedade de navegação para a coleção de prontuários associados a este paciente
        public ICollection<ProntuarioModel> Prontuarios { get; set; } = new List<ProntuarioModel>();
    }
}
